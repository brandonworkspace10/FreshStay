...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      {/* Brand-teal dim + tint so the letters stay readable on top */}
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[#0a3b38]/72"
      />
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-gradient-to-r from-[#062826]/85 via-[#0a3b38]/45 to-[#13a08c]/25"
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24 lg:py-28">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button
                ...
                size="lg"
                className="bg-fresh text-fresh-foreground hover:bg-fresh/90 min-h-12 cursor-pointer text-base font-semibold shadow-lg shadow-black/20"
              >
              ...
              <a
                href="/pricing"
                className="inline-flex min-h-12 items-center justify-center px-4 text-base font-medium text-white underline-offset-4 transition-colors hover:text-fresh-light focus-visible:text-fresh-light"
              >
                See plan pricing
              </a>
            </div>
            <ul
              className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm text-white/85"
              aria-label="Trust indicators"
            >
              <li className="flex items-center gap-2">
                <Star
                  className="size-4 fill-fresh-light text-fresh-light"
                  aria-hidden="true"
                />
                <span>
              ...
              <li className="flex items-center gap-2">
                <ShieldCheck
                  className="size-4 text-fresh-light"
                  aria-hidden="true"
                />
                <span>Insured &amp; background-checked</span>
              </li>
              <li className="flex items-center gap-2">
                <Users className="size-4 text-fresh-light" aria-hidden="true" />
          ...
          <div className="lg:pl-4">
            <TurnoverTimeline />
            <p className="mt-4 text-center text-sm text-white/75 lg:text-left">
